...
SIMULADOS = {
    ...
    "11C2": [(4, 2, "S3-11", "2º ao 7º tempos"), (4, 3, "S3-11", "2º ao 7º tempos"),
             (13, 1, "S4-11", "2º ao 7º tempos"), (13, 2, "S4-11", "2º ao 7º tempos")],
    "12C1": [(8, 3, "S4-12", "2º ao 7º tempos"), (8, 4, "S4-12", "2º ao 7º tempos")],  # 23-24/09/2026 (era 16-17/09)
    "12C2": [(8, 3, "S4-12", "2º ao 7º tempos"), (8, 4, "S4-12", "2º ao 7º tempos")],  # 23-24/09/2026 (era 16-17/09)
}
...
def montar_exames(turma):
    ...
    for disc, profs in sorted(discs.items()):
        ...
        if disc in UM_TEMPO:
            ...
            n = 1 if disc in UM_TEMPO_POR_TURMA.get(turma, ()) else 2
            e.append((disc, prof, n, 1))
            if disc not in UMA_PROVA_POR_TURMA.get(turma, ()):
                e.append((disc, prof, n, 2))
    return e
